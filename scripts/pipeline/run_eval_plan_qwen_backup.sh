...
# Backup: Qwen provider evaluation pipeline (original style).
# Usage:
#   export QWEN_API_KEYS="key1,key2,..."  # or QWEN_API_KEY
#   bash scripts/pipeline/run_eval_plan_qwen_backup.sh
...
plots_root="$ROOT/results/plots_web_refactor_v2"
mkdir -p "$plots_root"
